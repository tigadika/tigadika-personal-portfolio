          ...
          >
            <div className="z-40 flex w-full flex-col items-center gap-10 text-center">
              ...
              <div className="flex gap-4">
                ...
                <button className="hover:-translate-y-1 rounded-md font-semibold flex items-center gap-2 border border-zinc-500 px-4 py-2 text-sm text-gray-200 transition duration-500 ease-in-out hover:border-zinc-400">
                  <FaGithub />
                  Github
                </button>
              </div>
